...
export default function PrayerTimesCard() {
  ...
  return (
    <Card
      className={cn(
        "relative w-full shadow-lg overflow-hidden transition-all duration-300",
    ...
    >
      <CardHeader className="relative flex flex-col space-y-3 z-10">
        ...
        <div className="space-y-4">
          ...
          {isLocationLoading ? (
            <div className="flex items-center text-sm text-gray-500 justify-center h-10">
                ...
                return (
                  ...
                  >
                    <div
                      className={cn(
                        "text-[10px]",
                        isNext ? "text-green-900" : "text-gray-500"
                      )}
                    >
                      {isNext ? "Sholat Berikutnya" : null}
                    </div>
                    <div
                      className={cn(
